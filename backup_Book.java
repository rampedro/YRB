...
public class Book {
	...
	while (true) {
		...
		System.out.print("Please type in the name of a tile (in category " + catName + "): ");
		titleName = sc.nextLine();

		if (getBookInformation()) {
			break;
		}
	}
	...
	Timestamp timestamp = new Timestamp(System.currentTimeMillis());
        ...
        String queryText =
          ...
          + "values(" + custID + ",'" + club + "', '" + titleName + "'," + year + ",'" + timestamp + "'," + num + ")";
    ...
    public void getMinimumPrice() {
        ...
        queryText =
          ...
          + "WHERE yrb_offer.title = '" + titleName
